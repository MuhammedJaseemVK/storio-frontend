        ...
        <div>
            ...
            <div className='w-screen h-screen bg-black text-white p-5 relative'>
                ...
                <div className='bg-transparent absolute right-5 left-5 bottom-16 rounded-t-2xl pb-12'>
                    <div onClick={ashowpopup} className={`${animate ? 'scale-in-out' : ''} rounded-full px-3 py-2 bg-white  duration-300 peer mb-5 w-full flex justify-between items-center`}>
                        <h3
